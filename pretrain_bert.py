...
from megatron.core.models.bert.bert_layer_specs import get_bert_layer_with_transformer_engine_spec, bert_layer_local_spec
...
def model_provider(pre_process=True, post_process=True, vp_stage=None):
    ...
    if args.use_legacy_models:
        ...
        if args.spec is None:
            transformer_layer_spec = get_bert_layer_with_transformer_engine_spec(args.num_experts, args.moe_grouped_gemm) #default spec
